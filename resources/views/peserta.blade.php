...
<head>
    ...
    <title>Pendaftaran Seminar Peserta</title>
</head>
<body>
    <div class="text-center text-4xl font-bold text-[#512B81] my-10">
        Pendaftaran Seminar Peserta
    </div>
    <div class="block text-center my-[50px] bg-[#80B3FF] w-[35%] py-10 rounded-xl mx-auto">
        <form action="/PendaftaranSeminarPeserta" method="POST" class="inline-block" enctype="multipart/form-data">
            @csrf
            <div class="relative">
